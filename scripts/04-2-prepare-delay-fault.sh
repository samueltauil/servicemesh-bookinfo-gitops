...
# setting up v2 for users samuel
...
# create a fault injection rule to delay traffic coming from the test user samuel
curl -s https://raw.githubusercontent.com/maistra/istio/maistra-2.1/samples/bookinfo/networking/virtual-service-ratings-test-delay.yaml | sed 's/exact: jason/exact: samuel/' | oc apply -f -
